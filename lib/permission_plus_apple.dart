...
/// Apple (iOS & macOS) implementation of [PermissionPlusPlatform].
///
...
class PermissionPlusApple extends PermissionPlusPlatform {
  ...
  static void registerWith() {
    PermissionPlusPlatform.instance = PermissionPlusApple();
  }
  ...
  Stream<PermissionStatus> permissionStatusStream(PermissionType permission) {
    throw UnimplementedError(
      'permissionStatusStream() is not implemented on Apple platforms.',
    );
  }
}
